...
vim.g.have_nerd_font = true --Nerd Font installed and selected
...
vim.opt.timeoutlen = 300 -- decrease time
vim.opt.splitright = true -- configue how new splits should be opened
vim.opt.splitbelow = true
vim.opt.list = true
vim.opt.listchars = { tab = '» ', trail = '·', nbsp = '␣' }
vim.opt.inccommand = 'split' -- preview substittions live
